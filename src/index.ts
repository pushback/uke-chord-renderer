...
program
  ...
  .option('--strokethin <px>', 'frets stroke thin width', ChordDefaultOptions.strokethin)
  .option('--strokebold <px>', 'frets stroke bold width', ChordDefaultOptions.strokebold)
  .option('--strokecolor <color>', 'frets stroke color. #RRGGBB[AA]', ChordDefaultOptions.strokecolor)
